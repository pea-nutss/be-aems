...
public class GuestService {
    ...
    public Guest saveGuest(Guest guest) throws IOException, WriterException, MessagingException {
        boolean isTableNumberExists = guestRepository.existsByTableNumberAndEventNameReference
                (guest.getTableNumber(), guest.getEventNameReference());

        if(isTableNumberExists){
            throw new IllegalStateException("Table number already exist");
        }
